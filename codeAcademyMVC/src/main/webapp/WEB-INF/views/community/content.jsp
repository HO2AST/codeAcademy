	...
	<div class="col-md-11-content">
		<table id="notice">
			...
			<tr>
				...
				<td class="left" width="200px"><fmt:formatDate value="${board.regDate}" pattern="yyyy년 MM월 dd일" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<c:forEach var="attach" items="${attachList}">
					<a style="font-size:12px;" href="upload/${attach.filename}" download>
					${attach.filename}
					</a><br>
				</c:forEach>
				</td>
				...
				<td class="left1" colspan="4" width="600px">
					<c:forEach var="attach" items="${attachList}">
						<c:if test="${attach.filetype eq 'I'}">
							<img src="upload/${attach.filename}" width="450px" height="auto" style="margin: 10px 10px 10px 10px;">
						</c:if>
					</c:forEach>
					<br>
					<span style="font-size: 14px;">${attach.content}</span>
				</td>
			</tr>
		</table>
