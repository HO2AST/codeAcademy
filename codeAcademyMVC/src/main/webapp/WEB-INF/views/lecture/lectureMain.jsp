...
<div class="firsthomecontent">
	<a href="https://www.javatpoint.com/java-tutorial">
	    <div class="homecontent"><img src="imgs/java.png" alt="JAVA"/>
	        <p>JAVA</p>
	    </div>
	</a> 
</div>
...
<div class="firsthomecontent">
	<a href="https://www.javatpoint.com/html-tutorial">
	    <div class="homecontent"><img src="imgs/html.png" alt="HTML"/>
	        <p>HTML</p>
	    </div>
	</a> 
	<a href="https://www.javatpoint.com/css-tutorial">
	    <div class="homecontent"><img src="imgs/css3.jpg" alt="CSS"/>
	        <p>CSS</p>
	    </div>
	</a>
	<a href="https://www.javatpoint.com/javascript-tutorial">
	    <div class="homecontent"><img src="imgs/javascript.png" alt="JavaScript"/>
	        <p>JavaScript</p>
	    </div>
	</a>
	<a href="https://www.javatpoint.com/jquery-tutorial">
	    <div class="homecontent"><img src="imgs/jquery.png" alt="jQuery"/>
	        <p>jQuery</p>
	    </div>
	</a>
	<a href="https://www.javatpoint.com/ajax-tutorial">
	    <div class="homecontent"><img src="imgs/ajax.png" alt="AJAX"/>
	        <p>AJAX</p>
	    </div>
	</a>
</div>
...
<div class="firsthomecontent">
	<a href="https://www.javatpoint.com/oracle-tutorial">
	    <div class="homecontent"><img src="imgs/oracle.png" alt="Oracle" />
	        <p>Oracle</p>
	    </div>
	</a> 
	<a href="https://www.javatpoint.com/mysql-tutorial">
	    <div class="homecontent"><img src="imgs/mysql.png" alt="MySQL" />
	        <p>MySQL</p>
	    </div>
	</a> 
</div>
