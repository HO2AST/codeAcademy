...
<body>
	...
	<jsp:include page="../include/header.jsp"/>
		...
		<form name="frm" action="memberInfoUpdate.do" method="post" class="join_form" onsubmit="return check();">
			<div id="join_header">
				<h2>정보수정</h2>
		...
		<div id="join_container">
			<div id="join_id">
				아이디 <br> <input type="text" id="id" name="id" autofocus="autofocus" value="${id}" readonly><br><span id="idMessage"></span>
			</div>
			<div id="join_passwd">
				비밀번호<button type="button" id="psswdChange" onclick="location.href='checkPasswdForm.do'">변경</button> <br> <input type="password" id="passwd1" name="passwd">
			</div>
			<div id="join_name">
