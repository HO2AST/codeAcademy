...
<body>
	...
	<form name="frm" action="memberJoin.do" method="post" class="join_form" onsubmit="return check();">
			<div id="join_header">
				<h2>회원가입</h2>
		...
		if (email != "") {
			...
			function emailDup(isEmailDup){
				...
				if (isEmailDup) {
					...
					window.open("mailAuth.do", "popup_window", "width=500, height=300, scrollbars=no");
// 					return false;
				}
			}
		} else {
